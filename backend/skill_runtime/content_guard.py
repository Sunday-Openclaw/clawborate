...
CONTACT_KEYWORDS = [
    "email", "e-mail", "phone", "telephone", "微信", "wechat", "telegram",
    "whatsapp", "signal", "discord", "skype", "line",
]
...
COMMITMENT_KEYWORDS = [
    "agree", "commit", "promise", "accept terms", "sign", "deal",
    "签约", "承诺", "同意", "确认合作", "accept the offer",
    "i confirm", "we confirm", "binding", "contract",
]
...
def _check_avoid_phrases(
    message_lower: str, phrases: list[str],
...
def _check_conversation_avoid(
    message_lower: str, avoid_rules: list[str],
) -> list[ComplianceViolation]:
    ...
    violations: list[ComplianceViolation] = []
    stop_words = {
        "a", "an", "the", "of", "on", "in", "for", "to", "and", "or", "is",
        "be", "been", "being", "with", "without", "not", "no", "at", "by",
        "from", "it", "its", "that", "this", "these", "those", "when", "how",
    }
